...
def sample_functions(params, inputs, data, num_functions):
    ...
    log_a_encoder = data_moments[:, :(truncation_level-1)]
    log_b_encoder = data_moments[:, (truncation_level-1):]
...
if __name__ == '__main__':
    ...
    decoder_arch = [dimx + truncation_level, 8,8, 2 * dimy]
